 ...
 * 
 */
app.controller('ChatCtrl', ['$rootScope' ,'$scope', 'socket', function($rootScope ,
...
(message) {
    ...
    $scope.$on('sockConnected', function(event, frame) {
        ...
        /**
        $scope.stompClient.subscribe("/queue/chats" + queueSuffix, function
...
(message) {
    ...
    */
        $scope.stompClient.subscribe( "/queue/chats/"+$scope.userName, function
